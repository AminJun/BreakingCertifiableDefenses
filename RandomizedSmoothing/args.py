...
class Args:
    ...
    def _get_parser():
        ...
        parser.add_argument('-b', '--batch', type=int, default=300, help='Batch size')  # was 1000
        parser.add_argument('-k', '--skip', type=int, default=1, help='How many examples to skip for validation')
        parser.add_argument('-a', '--alpha', type=float, default=0.001, help='Failure probability')
        parser.add_argument('--N0', type=int, default=100)
        parser.add_argument('--N', type=int, default=100000, help='number of samples to use')

        parser.add_argument('-n', '--steps', default=512, type=int, help='#PGD steps')
        ...
        parser.add_argument('-t', '--tv_lam', type=float, default=0.1, help='TV-Lambda')
        parser.add_argument('-e', '--ch_lam', type=float, default=20.0, help='Channels Lambda')
        parser.add_argument('-s', '--dissim_lam', type=float, default=5.0, help='Sim Lambda')
        return parser
