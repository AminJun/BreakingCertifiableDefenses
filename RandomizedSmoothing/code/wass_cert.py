...
from attack import Wasserstein
import numpy as np
...
if __name__ == "__main__":
    ...
    attacker = Wasserstein(base_classifier)
    ...
    for i in range(0, len(dataset), args.skip):
        ...
        c_name = 'wass_l2_best_{}_{}_{}_{}_{}_{}_{}'.format(args.sigma, args.tv_lam, args.c_lam, args.steps, args.batch, i,
                                               args.s_lam)
        for target in targets:
            adv_x = attacker.perturb(x=first_x, y=target, eps=args.sigma, total_steps=args.steps, batch_size=400)
